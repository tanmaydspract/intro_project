...
class IntroClass(APIView):
    ...
    def get(self, request):
        ...
        return Response({"msg":f"hello {request.query_params.get('name')}!! this is from latest production enviornment, your calculation : {str(int(request.query_params.get('a1'))+int(request.query_params.get('a2')))}"})